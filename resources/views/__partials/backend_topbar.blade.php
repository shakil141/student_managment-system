<header class="u-header">
    <div class="u-header-left">
        <a class="u-header-logo" href="{{ route('dashboard') }}">
            ...
            <img class="img-fluid u-logo-mobile" src="{{ asset('assets/img/logo-mobile.png') }}" width="50" alt="Stream Dashboard">
        </a>
    </div>
    ...
    <div class="u-header-right">
                        ...
                        <div class="list-group list-group-flush">
                            ...
                            <a class="list-group-item list-group-item-action" href="#">
                                <div class="media align-items-center">
                                    <img class="u-avatar--sm rounded-circle mr-3" src="{{ asset('assets/img/avatars/img1.png') }}" alt="Image description">
                            ...
                            <a class="list-group-item list-group-item-action" href="#">
                                <div class="media align-items-center">
                                    <img class="u-avatar--sm rounded-circle mr-3" src="{{ asset('assets/img/avatars/img2.jpg') }}" alt="Image description">
                            ...
                            <a class="list-group-item list-group-item-action" href="#">
                                <div class="media align-items-center">
                                    <img class="u-avatar--sm rounded-circle mr-3" src="{{ asset('assets/img/avatars/user-unknown.jpg') }}" alt="Image description">
                            ...
                            <a class="list-group-item list-group-item-action" href="#">
                                <div class="media align-items-center">
                                    <img class="u-avatar--sm rounded-circle mr-3" src="{{ asset('assets/img/avatars/img4.jpg') }}" alt="Image description">
        ...
        <div class="dropdown ml-2">
            <a class="link-muted d-flex align-items-center us-u-avatar-wrap" href="#!" role="button" id="dropdownMenuLink" aria-haspopup="true" aria-expanded="false" data-toggle="dropdown">
                <img class="u-avatar--xs img-fluid rounded-circle mr-2 bg-gradient" src="{{ asset('assets/img/avatars/img1.png') }}" alt="User Profile">
